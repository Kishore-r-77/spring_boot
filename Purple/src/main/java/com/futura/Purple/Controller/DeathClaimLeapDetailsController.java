...
public class DeathClaimLeapDetailsController {
	...
	@GetMapping("/getByUinNo/{policyNo}")
	public ResponseEntity<DeathClaimLeapDetails> getByUinNo(@PathVariable String uinNo) {
		return new ResponseEntity<>(deathClaimService.getByUinNo(uinNo), HttpStatus.OK);
	}
...
//	@PatchMapping("/qcUpdate/{uinNumber}/{userId}")
//    public ResponseEntity<String> qcUpdate(@RequestBody DeathClaimLeapDetails entity,@PathVariable String uinNumber,@PathVariable Long userId){
//    	return new ResponseEntity<String>(deathClaimService.qcUpdate(entity ,uinNumber,userId),HttpStatus.OK);
//    }
