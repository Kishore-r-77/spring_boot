...
public class DeathClaimCoverDetailsController {
	...
	@GetMapping("/getByUinNo/{uinNo}")
	public ResponseEntity<?> viewAllByPolicy(@PathVariable String uinNo) {
		return ResponseEntity.ok(coverDetailsService.getByUinNo(uinNo));
	}
