...
public class DeathClaimTransactionPasController {
	...
	@GetMapping("/getProcessedByUinNo/{uinNo}")
	public DeathClaimTransactionPas findProcessedByUinNo(@PathVariable Long uinNo) {
		return deathClaimTransService.findProcessedByUinNo(uinNo);
	}
